# NOTE: PR #5 version of h10_scan (parallel session 4), kept under the _pr5
# suffix because a different scanner with the same name exists in
# experiments/h10_scan.py.  Output directory: data/runs/h10_scan_pr5/.
...
Usage: python3 experiments/h10_scan_pr5.py --n 10 [--workers 4] [--slack 0]
Output: data/runs/h10_scan_pr5/scan_n<n>.json (+ .log), checkpoint scan_n<n>.ckpt.json
"""
...
SCAN_VERSION = "h10_scan-1.0-pr5"
OUT_DIR = os.path.join(ROOT, "data", "runs", "h10_scan_pr5")
