# NOTE: PR #5 version of check_C28 (parallel session 4), kept under the _pr5
# suffix because a different checker with the same name exists in
# checks/check_C28.py.  Output directory: data/runs/check_C28_pr5/.
...
Usage: python3 checks/check_C28_pr5.py [--max-n 64] [--sigma-max-n 200] [--min-max-n 40]
Output: data/runs/check_C28_pr5/report.json and summary.md
"""
...
CHECK_VERSION = "check_C28-1.0-pr5"
OUT_DIR = os.path.join(ROOT, "data", "runs", "check_C28_pr5")
